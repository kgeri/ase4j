...
public class WebIndexer {
	...
	private void index(String url, int level) throws IOException, IllegalStateException,
		...
		Collection<Association<String, DynamicObject>> assocs = new LinkedList<Association<String, DynamicObject>>();
		...
		while (tok.hasMoreTokens()) {
			...
			assocs.add(new Association<String, DynamicObject>(token, null, 1.0F));
		}
