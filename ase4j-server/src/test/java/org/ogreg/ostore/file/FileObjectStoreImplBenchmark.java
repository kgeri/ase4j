...
public class FileObjectStoreImplBenchmark {
	 ...
	 * <p>
	 * This test measures how fast the store can synthesize objects (used a lot
	 * when filtering).
	 * </p>
	 */
	 ...
	 * <p>
	 * This test measures how fast the store can find object ids by their unique
	 * keys (currently using a Trie with a URL dictionary).
	 * </p>
	 */
	@Test(dependsOnMethods = "testInsert01")
