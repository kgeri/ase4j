...
public abstract class BaseObjectStore<T> implements ConfigurableObjectStore<T>, Closeable {
	...
	private final Map<String, PropertyPersistor> persistors = new HashMap<String, PropertyPersistor>();
	 ...
	 * (so this may be null), but some operations will only work if there is
	 * one.
	 * </p>
	 */
	// TODO Composite id
	...
	/**
	 * The implementor should update its maximum identifier if it is less than
	 * the given value.
	 * 
	 * @param identifier
	 */
	protected abstract void updateMaxId(long identifier);
	...
	/**
	 * The implementor should create an implementation specific simple property
	 * persistor here.
	 * 
	 * @param propertyType
	 * @param propertyName
	 * @return
	 */
	protected abstract PropertyPersistor createPersistor(Class<?> propertyType, String propertyName);

	/**
	 * The implementor should create an implementation specific extension
	 * persistor here.
	 * 
	 * @param propertyName
	 * @return
