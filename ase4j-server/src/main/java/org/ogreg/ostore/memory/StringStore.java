...
public class StringStore implements ConfigurableObjectStore<String>, Serializable {
    ...
    @Override public long save(String entity) throws ObjectStoreException {
    ...
    @Override public long saveOrUpdate(String entity) throws ObjectStoreException {
        return save(entity);
    }

    @Override public void add(long identifier, String entity) throws ObjectStoreException {
    ...
    @Override public String get(long identifier) throws ObjectStoreException {
