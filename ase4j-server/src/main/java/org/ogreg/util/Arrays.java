...
public abstract class Arrays {
	 ...
	 * binary search algorithm. The array must be sorted ascending prior to
	 ...
	 *          - 1)</tt>. The <i>insertion point</i> is defined as the point at
	 *         which the key would be inserted into the array: the index of the
	 *         first element greater than the key, or <tt>a.length</tt> if all
