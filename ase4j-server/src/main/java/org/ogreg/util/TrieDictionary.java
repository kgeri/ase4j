...
public class TrieDictionary implements Serializable {
     ...
     *
     * <p>The mapping is as follows (unknown characters are mapped to ' '):</p>
     *
     * <pre>
     ...
     *
     * <p>You may specify an array of arrays, where elements of each array will be mapped to their array index. This way
     * it is possible to map multiple characters to the same code (the encoding is lossy) - when decoding, the first
     * array's characters will be used.</p>
     *
     * <p>Note: for performance reasons, every unknown character will be mapped to the 0th char of this string.</p>
     *
     * @param  dictionary
     */
